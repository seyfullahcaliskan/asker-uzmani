...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-black pt-2 border-t border-black cabin">
      <div className="flex flex-col justify-center items-center border-b border-black mb-6 space-y-4">
        <div className="relative w-full max-w-5xl aspect-[6/1]">
          <Image
        ...
        <div className="relative w-full max-w-5xl aspect-[7/1]">
          <Image
            src="/images/paytr/tekparca-logolar-1.jpg"
            alt="Taksitli Ödeme Seçenekleri"
            fill
            className="object-contain"
            sizes="(max-width: 768px) 100vw, 800px"
          />
